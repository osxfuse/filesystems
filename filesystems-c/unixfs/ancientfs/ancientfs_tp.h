...
#ifndef _ANCIENTFS_TP_H_
#define _ANCIENTFS_TP_H_
...
ancientfs_tp_mode(mode_t mode, uint32_t flags)
{
    mode_t newmode = 0;
...
static inline int
ancientfs_tp_cksum(uint8_t* de, fs_endian_t e, uint32_t flags)
{
